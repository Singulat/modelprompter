...
|-|-|-|
| ![](https://github.com/singulat/modelprompter/assets/151397270/68ddf351-b9de-481e-821f-abb7494e5448) | ![](https://github.com/singulat/modelprompter/assets/151397270/9296d533-5130-4a5a-a41e-d9cec4fc15b5) | ![](https://github.com/singulat/modelprompter/assets/151397270/74876598-bc22-4a96-a43e-76b0fcc21098) |
...
### Planning
After the Skills are gathered, a new message stack is created by combining the Planning Prompt, the relevant Skills, and all of the Channel's messages and sent back to the LLM. This time, any output from the LLM rendered in a `<pre class="mp"></pre>` will get extracted and run as JavaScript in the context of the browser extension.
...
Once the plan has been output and all of the code extracted and run, the Chat Turn has ended and the user must type another prompt to continue. However, ModelPrompter exposes `mp.prompt(newPrompt)` so that the LLM can act on behalf of the user and continue iterating on the plan.
...
git clone https://github.com/singulat/modelprompter
cd modelprompter
...
<img width="906" alt="image" src="https://github.com/singulat/modelprompter/assets/151397270/7768ff80-5f03-43e8-9f5f-5b3924b1a4e9">
